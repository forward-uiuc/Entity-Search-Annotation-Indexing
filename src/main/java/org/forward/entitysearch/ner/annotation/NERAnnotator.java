...
import org.forward.entitysearch.ner.annotation.extraction.EntityExtractor;
...
//					builderHash.get(tid + "_end").append("oentityo|"+ hash + " ");
					builderHash.get(tid + "_begin").append("obegin_"+tid+ " " +token.getContent() + " oend_"+tid+" ");
					builderHash.get(tid + "_end").append("obegin_"+tid+ " " +token.getContent() + " oend_"+tid+" ");
				}
			}
